...
<?php    
    $stmt = $conn->prepare("SELECT * FROM `counter` WHERE link = 'polanco'");
    $stmt->execute();
    $row = $stmt->fetch();
    $id = $row['id'];
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div style="height: 25vh; width: auto; overflow: auto; clear: both;">
                                        <p>The Solid Waste Management Program (SWM) of LGU-Polanco is practically an adoption of RA 9003. Municipal Ordinance No.15-24 entitled “Comprehensive Solid Waste Management Ordinance of Polanco, Zamboanga del Norte” was enacted to embrace the provisions under RA 9003.</p>
                                        <p>The primary goal of the Ordinance is to enhance ecological balance of the community through sustainable and integrated waste management.</p>
                                ...
                                <div class="list-single-main-item fl-wrap" id="sec3">
                                    ...
                                    <div class="gallery-items grid-small-pad  list-single-gallery three-coulms lightgallery">
                                        ...
                                        <div class="gallery-item">
                                            <div class="grid-item-holder">
                                                <div class="box-item">
                                                    <img src="polanco/images/2.jpg"   alt="">
                                                    <a href="polanco/images/2.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="gallery-item">
                                            <div class="grid-item-holder">
                                                <div class="box-item">
                                                    <img src="polanco/images/3.jpg"   alt="">
                                                    <a href="polanco/images/3.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                                </div>
                                            </div>
                                        </div>
